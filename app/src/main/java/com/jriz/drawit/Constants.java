...
public class Constants {
    /*This section is used to button texts*/
    static final String TXT_OPEN = "Abrir";
    ...
    static final String INTERNAL_FAILEDTOOPEN = "FailOpeningFile";
    static final String INTERNAL_FAILEDTOSAVE = "FailSavingFile";
    static final String INTERNAL_DOTTXT = ".txt";
    /*This section is used to internal actions*/
